...
import br.com.hamaral.wschecklist.controller.exception.ValidationError;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				.globalResponseMessage(RequestMethod.GET, Arrays.asList(code200, code400, code405, code500))
				...
				.globalResponseMessage(RequestMethod.DELETE, Arrays.asList(code200, code400, code405, code500))
				.additionalModels(typeResolver.resolve(StandardError.class),
						typeResolver.resolve(ValidationError.class))
				.select().apis(RequestHandlerSelectors.basePackage("br.com.hamaral.wschecklist.controller"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("Web Service para o Sistema de Checklist",
				"Este Web Service é utilizado por Heitor Amaral para fins educacionais.", "Versão 1.0", "",
				new Contact("Heitor", "https://github.com/HeitorAmaral", "heitor.amaral90@outlook.com"),
				"Permitido uso educacional", "", Collections.emptyList());
	}
}